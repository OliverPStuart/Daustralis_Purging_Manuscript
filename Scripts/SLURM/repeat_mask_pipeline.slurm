...
grep ">" RM_3767039.TueOct241448172023/consensi.fa.classified | grep "#Unknown" | sed 's/^>//g' > consensi.fa.classified.unknown_names
grep ">" RM_3767039.TueOct241448172023/consensi.fa.classified | grep -v "#Unknown" | sed 's/^>//g' > consensi.fa.classified.known_names
seqtk subseq LHISI_Scaffold_Assembly_Polished-families.fa consensi.fa.classified.known_names > consensi.fa.classified.known
seqtk subseq LHISI_Scaffold_Assembly_Polished-families.fa consensi.fa.classified.unknown_names > consensi.fa.classified.unknown
...
cat 01_simple_out/LHISI_Scaffold_Assembly_Polished.simple_mask.align \
...
# Download Daren Card's custom gff making script (just bash required) and process repeat output to gff for later

wget https://raw.githubusercontent.com/darencard/GenomeAnnotation/master/rmOutToGFF3custom
bash rmOutToGFF3custom -o 05_full_out/LHISI_Scaffold_Assembly_Polished.full_mask.out > 05_full_out/LHISI_Scaffold_Assembly_Polished.full_mask.gff3
bash rmOutToGFF3custom -o 05_full_out/LHISI_Scaffold_Assembly_Polished.simple_mask.out > 05_full_out/LHISI_Scaffold_Assembly_Polished.simple_mask.gff3
bash rmOutToGFF3custom -o 05_full_out/LHISI_Scaffold_Assembly_Polished.complex_mask.out > 05_full_out/LHISI_Scaffold_Assembly_Polished.complex_mask.gff3

# Make a bed file from the full mask to use for variant filtering etc.

awk 'NR > 1 {print $1"\t"$4-1"\t"$5-1}' 05_full_out/LHISI_Scaffold_Assembly_Polished.full_mask.gff3 > Annotation/repeats.bed
